    ...
    <el-table :key="tableKey" :data="list" border fit highlight-current-row>
      <el-table-column label="地址" align="center">
        <template slot-scope="{row}">
          <span class="link-type" @click="handleActivemqInfo(row)">{{ row.addr }}</span>
        </template>
      </el-table-column>
